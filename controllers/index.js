...
const index = async (req, res) => {         
	const { userId,lastName, firstName, middleName, homeAddress, country, stateId, city, zipCode, birthdate, gender, hobby, civilStatus } = req.body
    ...
    try {
      const result = await prisma.userDetails.create({
        data: {
          ...
          shiftKeyA: shiftKeyA,
          shiftKeyB: shiftKeyB,
          // You must also provide the associated userId
